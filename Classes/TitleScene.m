...
-(id) init
{
    if( (self=[super initWithColor:ccc4(255,255,255,255)] )) {
        ...
        CCLabel *label = [CCLabel labelWithString:@"Wizards vs. Zombies" fontName:@"Arial" fontSize:32];
        label.color = ccc3(255,255,255);
        label.position = ccp(winSize.width/2, winSize.height/2 + 60);
        [self addChild:label];
        
        CCLabel *prompt = [CCLabel labelWithString:@"Tap to Start" fontName:@"Arial" fontSize:24];
